...
function DeleteRetailerDialog({retailer, open, handleDelete, handleClose}){
    ...
    return(
        <>
            ...
            <Button className="ml-8" variant="outlined" onClick={() => {handleDelete(retailer.id)}}>
                Yes, Delete
            </Button>
            </DialogFooter>
        </Dialog>
...
export default DeleteRetailerDialog;