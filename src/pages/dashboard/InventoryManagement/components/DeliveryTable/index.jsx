...
const TABLE_HEAD = ["Order Date", "Delivery Date", "Product", "Quantity", "Retailer", "Status", "Action"];
      ...
      <Card className="h-full w-full">
        ...
        <div className="ml-4">
          <div className="flex w-full justify-between gap-4">
            ...
            <Button value="newdelivery" onClick={handleOpen}  className="flex items-center mr-6 gap- bg-blue" size="sm">
